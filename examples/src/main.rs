use asaka_core::attention::{Attention, AttentionConfig};
use asaka_core::knowledge::Document;
use clap::{command, Parser};
use rig::providers::{self, openai};

use asaka_core::character;
use asaka_core::init_logging;
use asaka_core::knowledge::KnowledgeBase;
use asaka_core::loaders::github::GitLoader;
use asaka_core::{agent::Agent, clients::discord::DiscordClient};
